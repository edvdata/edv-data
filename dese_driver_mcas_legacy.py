...
request_params['ctl00$ContentPlaceHolder1$ddYear'] = ['2013']
...
request_params['ctl00$ContentPlaceHolder1$ddSubGroup'] = ['AL:AL', 'FL:N', 'FL:Y', 'ED:N', 'ED:Y', 'HN:Y', 'RA1:01', 'RA1:02', 'RA1:03', 'RA1:04', 'RA1:06', 'RA1:15', 'RA1:20', 'SS:LEP', 'SS:SPED', 'SS:Non-SPED']
