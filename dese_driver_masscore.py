...
request_params['ctl00$ContentPlaceHolder1$ddYear'] = ['2022']
request_params['ctl00$ContentPlaceHolder1$ddSubgroup'] = ['ALL', 'FE', 'MA', 'ED', 'HN', 'LEP', 'FL', 'SWD', 'AA', 'AI', 'AS', 'HI', 'MR', 'NH', 'WH']
